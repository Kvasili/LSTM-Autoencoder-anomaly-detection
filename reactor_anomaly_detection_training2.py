...
config = {
    ...
    # This model is trained with the 6 initial features
    # "model_name": "./models/lstm_autoencoder_replay_v2.model",

    # This model is trained with the 9 initial features
    # "model_name": "./models/lstm_autoencoder_replay_v4.model",
    # This model is trained with 6 features
    # "model_name": "./models/lstm_autoencoder_replay_v4b.model",

    # This model is trained with both SCRAMS and Ganglowers
    "model_name": "./models/lstm_autoencoder_replay_full_cycle_v6.model",
...
def main():
    ...
    # columns = ["Channel 1 counts", "Channel 3 power", "Channel 4 flux", "rr-active-state",
    ...
    for file_name in os.listdir(config['training_folder']):
        if file_name.endswith('.csv'):
            ...
            # use only rows 300 to 399 where the SCRAM is happening
            # df = pd.read_csv(
            #     file_path,
            #     usecols=columns,
            #     skiprows=lambda x: x != 0 and (x < 300 or x > 399)
            # )
