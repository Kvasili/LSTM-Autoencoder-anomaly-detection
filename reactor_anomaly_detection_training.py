...
def main():
    ...
    train_scaled, test_scaled = normalize_data(
        df_normal, df_abnormal, 'Standard', config['model_normalization'])
    ...
    if config['save_models']:
        model.save('./models/'+config['model_name'], save_format="h5")
        print("[INFO] Model saved.")

    # if config['save_model']:
    #     model.save("lstm_autoencoder_SCRAM_v2.model", save_format="h5")
    #     print("Model saved!")
    #     # try:
